...
'''
class MyOutputFormat(BaseModel): # structured response 
    step: str = Field(...,description="This Id of the step. Example: PLAN, TOOL")
    content: Optional[str] = Field(None,description="The optional string content for the steps")
...
with sr.Microphone() as source:# mic access
    ...
    r.pause_threshold =2 # if 2 seconds break while speaking then it continue working 
...
while True:
    ...
    user_query  = r.recognize_bing(audio)
...
#   },
    ...
    if parsed_result.step == "TOOL":
        tool_to_call = parsed_result.input
